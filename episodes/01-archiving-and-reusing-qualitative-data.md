...
One of the most commonly-analyzed types of raw qualitative data is interview transcripts, like we have in our project. NVivo provides support for working directly with audio and video files, but text is often preferred, particularly when sharing projects, because it simplifies the process of removing potentially identifying information and enables rapid scanning of content.

Let's open one of the Big Social transcripts, `Mannheimer_BSR01_Transcript.pdf` and look at how they are structured in this project, including elements common to many transcripts.
...
Alternatively, this activity may be moved to after the NVivo project is created, in which case learners can view the transcript directly in their project and use linked memos to annotate any notes relevant to their project.
:::

### Codebooks

*Coming soon - activities using codebooks or code dictionaries to help brainstorm and organize new relevant concepts.*
...
![Launch menu for NVivo 14 Mac](fig/nvivo-launch-dialog-mac.png)
...
*More coming soon, with activities where users look at excerpts coded to specific codes and consider relevance to the new project.*

## Sharing Qualitative Data

*Coming soon - a brief discussion of the benefits (to the sharer) of sharing qualitative data.*
